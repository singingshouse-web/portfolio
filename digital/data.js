...
const SITE = {
  ...
  /* Hero 主標。備選：
     ...
     「每個畫面，都是一次取捨。」                        */
  heroTitle: "我們相信，\n**美感**本身就是最大的品牌競爭力。",
  heroSub: "專注於品牌網站的視覺設計與前端實作。從自有產品「擁抱情緒卡」到國際品牌的數位專案，我們用同一種標準對待每一個畫面。",
  /* Contact 區標題。備選：
     「有想做的東西，寫信給我們。」
     「從一封信開始。」                                  */
  ...
  about: {
    title: "關於心映好事",
    paragraphs: [
      "擁有二十多年多媒體與網頁設計經驗，曾於廣告設計品牌設計公司參與 IKEA、SK-II、兆豐銀行、台北 101 等品牌數位專案，專長為品牌網站視覺設計與前端實作，重視設計美感，也重視畫面的可用性與細節。",
      "與夥伴創立設計品牌「心映好事」，從品牌識別、產品設計、網站、線上抽牌系統到募資頁面，親自完成整體品牌體驗的規劃與執行。因為同時經營自有品牌，更理解品牌在不同階段真正需要的設計，而不只是完成一個漂亮的畫面。",
      "無論是自有產品或客戶委託，都以最高的美感標準，打造兼具設計感、品牌一致性與使用體驗的數位作品。"
    ],
